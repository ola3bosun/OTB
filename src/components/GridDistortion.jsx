...
  imageSrc,
  className = '',
  onImageLoad // Added onImageLoad prop
}) => {
...
      handleResize();
      if (onImageLoad) { // Call onImageLoad callback after successful image load
        onImageLoad();
      }
    },
...
        if (onImageLoad) { // Call onImageLoad even on error to hide loader
          onImageLoad(); // Or you could have a separate onError callback prop
        }
      }
    );
...
    };
  }, [grid, mouse, strength, relaxation, imageSrc, onImageLoad]); // Added onImageLoad to dependency array
